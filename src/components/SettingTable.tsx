    ...
    <div className={styles.settingTable}>
      <div className={styles.searchCondition}>
        <div className={styles.searchKeyword}>
          <input name="word" value={condition.word} onChange={handleChange} />
        </div>
      ...
      <div className={styles.table}>
        <table>
          ...
          <tbody>
            {displaySettings() &&
              displaySettings().map((setting: IRancheckEntity) => (
                <tr
                  key={setting._id}
            ...
            {numShortage > 0 &&
              range(numShortage).map((index: number) => (
                <EmplySettingTable key={index} />
              ))}
          </tbody>
        </table>
      </div>
